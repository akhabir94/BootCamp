...
public class CommonAPI {
    ...
    @BeforeClass
    public static WebDriver setupDriver(@Optional String platform, String url, @Optional("chrome") String browser, @Optional("false") boolean cloud, String browserVersion, String envName) throws MalformedURLException {
        if (cloud) {
    ...
    public static WebDriver getLocalDriver(String browser, String platform) {
        if (platform.equalsIgnoreCase("mac") && browser.equalsIgnoreCase("chrome")) {
            System.setProperty("webdriver.chrome.driver", "/Users/tanaka/Downloads/groupProject-master 3/generic/drivers/chromedriver 15");
